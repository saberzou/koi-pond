...
export const FISH_COLORS = [
  { body: '#D4722A', spots: '#FFFFFF', belly: '#F0E4D0' }, // orange/white
  { body: '#C4442A', spots: '#FFFFFF', belly: '#F0C8C8' }, // red/white
  { body: '#D4922A', spots: '#F5E6A3', belly: '#FFF5D6' }, // gold
  { body: '#1A1A1A', spots: '#D4722A', belly: '#4A3A2A' }, // black/orange
  { body: '#D4722A', spots: '#D4922A', belly: '#FFFFFF' }, // orange/gold
  { body: '#C4442A', spots: '#D4922A', belly: '#F0E4D0' }, // red/gold
  { body: '#F0E4D0', spots: '#C4442A', belly: '#FFFFFF' }, // white/red
];
